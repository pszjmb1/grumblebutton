...
Router.map(function() {
    ...
    this.route('issues', {template: 'issues'});
    this.route('closedIssues', {template: 'closedIssues'});
    this.route('subscribedKeywords', {template: 'subscribedKeywords'});    
    this.route('report', {path:'/sayit'});
    this.route('studyInfo', {template:'studyInfo'});
